...
pub use keyboard::{KeyboardInput, KeyboardConfig};
pub use mapper::{KeyMapper, QwertyMapper, CustomMapper};

use crate::error::InputError;
use crate::hardware::{Input, InputResult, ChipKey};
...
impl InputSystem {
    ...
    pub fn process_keyboard_event(&mut self, event: &keyboard::KeyboardEvent) -> InputSystemResult<()> {
